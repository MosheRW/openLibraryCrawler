...
async def orchestrator():
    ...
    want_to_read_prev, already_read_prev = await profile_page.get_want_and_already_read_quantities()
    ...
    for query in config.queries:
        ...
        await assert_reading_list_count(want_to_read_prev, already_read_prev)
